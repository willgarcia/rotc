...
<html lang="en">
<head>
    <title>Code coverage report for swssettings.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> swssettings.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* swagger-stats Settings */
&nbsp;
const os = require('os');
...
&nbsp;
<span class="fstat-no" title="function not covered" >    in</span>it(options) {
<span class="cstat-no" title="statement not covered" >        if(typeof options === 'undefined' || !options){</span>
<span class="cstat-no" title="statement not covered" >            return;</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        for(let op of Object.keys(this)){</span>
<span class="cstat-no" title="statement not covered" >            if(op in options){</span>
<span class="cstat-no" title="statement not covered" >                this[op] = options[op];</span>
            }
        }
&nbsp;
        // Set or detect node address
<span class="cstat-no" title="statement not covered" >        if(!('ip' in options)) {</span>
            // Attempt to detect network address
            // Use first found interface name which starts from "e" ( en0, em0 ... )
            let address = <span class="cstat-no" title="statement not covered" >null;</span>
            let ifaces = <span class="cstat-no" title="statement not covered" >os.networkInterfaces();</span>
<span class="cstat-no" title="statement not covered" >            for( let ifacename in ifaces ){</span>
                let iface = <span class="cstat-no" title="statement not covered" >ifaces[ifacename];</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        this.pathUI = this.uriPath+'/ui';</span>
<span class="cstat-no" title="statement not covered" >        this.pathDist = this.uriPath+'/dist';</span>
<span class="cstat-no" title="statement not covered" >        this.pathUX = this.uriPath+'/ux';</span>
<span class="cstat-no" title="statement not covered" >        this.pathStats = this.uriPath+'/stats';</span>
<span class="cstat-no" title="statement not covered" >        this.pathMetrics = this.uriPath+'/metrics';</span>
<span class="cstat-no" title="statement not covered" >        this.pathLogout = this.uriPath+'/logout';</span>
    }
&nbsp;
}
&nbsp;
