...
&nbsp;
    ...
    getPrometheusMetrics(prefix, metricDefs) {
        ...
        for (let metricId of Object.keys(metricDefs)) {
            ...
            <span class="missing-if-branch" title="else path not taken" >E</span>if ('labelNames' in metricDef) {
...
<span class="branch-1 cbranch-no" title="branch not covered" >                case 'gauge': {</span>
