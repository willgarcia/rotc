  ...
  <div class='pad1'>
    ...
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>234/263</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">70.12% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>115/164</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>220/237</span>
      </div>
    </div>
    <p class="quiet">
...
swsAPIStats.prototype.initBasePath = function(swaggerSpec,swsOptions) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if(('basePath' in swsOptions) &amp;&amp; (swsOptions.basePath!=='')){
<span class="cstat-no" title="statement not covered" >        this.basePath = swsOptions.basePath;</span>
    }else{
        <span class="missing-if-branch" title="else path not taken" >E</span>if( swaggerSpec.openapi &amp;&amp; swaggerSpec.openapi.startsWith('3') ){
            this.basePath = '/';
        }else{
...
<span class="cstat-no" title="statement not covered" >                this.basePath = '/' + this.basePath;</span>
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (this.basePath.charAt(this.basePath.length - 1) !== '/') {
<span class="cstat-no" title="statement not covered" >        this.basePath = this.basePath + '/';</span>
    }
};
&nbsp;
...
&nbsp;
                ...
                apiOpDef.deprecated = ('deprecated' in opDef) ? <span class="branch-0 cbranch-no" title="branch not covered" >opDef.deprecated </span>: false;
                ...
                <span class="missing-if-branch" title="if path not taken" >I</span>if( 'summary' in opDef ) <span class="cstat-no" title="statement not covered" >apiOpDef.summary = opDef.summary;</span>
                <span class="missing-if-branch" title="if path not taken" >I</span>if( 'tags' in opDef ) <span class="cstat-no" title="statement not covered" >apiOpDef.tags = opDef.tags;</span>
&nbsp;
    ...
    if( url in this.apiMatchIndex ){
        ...
        for(var swPath in this.apiMatchIndex) {
            if( this.apiMatchIndex[swPath].re !== null) {
                ...
                <span class="missing-if-branch" title="else path not taken" >E</span>if (matchResult &amp;&amp; (matchResult instanceof Array)) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if( 'in' in param ){
            switch(param.in){
                case "path":
                    ...
                    break;
                case "query":
                    <span class="missing-if-branch" title="if path not taken" >I</span>if( ('query' in req.sws) &amp;&amp; (pname in req.sws.query) ){
