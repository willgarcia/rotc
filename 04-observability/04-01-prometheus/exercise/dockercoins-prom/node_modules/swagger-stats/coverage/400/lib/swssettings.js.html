...
<html lang="en">
<head>
    <title>Code coverage report for lib/swssettings.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">lib</a> swssettings.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    init(options) {
        <span class="missing-if-branch" title="if path not taken" >I</span>if(typeof options === 'undefined' || !options){
...
&nbsp;
        ...
        <span class="missing-if-branch" title="if path not taken" >I</span>if(!('ip' in options)) {
