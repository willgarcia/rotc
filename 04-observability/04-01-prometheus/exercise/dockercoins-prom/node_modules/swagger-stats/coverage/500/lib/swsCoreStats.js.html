...
&nbsp;
        ...
        req.sws.inflightTimer = setTimeout(<span class="fstat-no" title="function not covered" >fu</span>nction() {
...
&nbsp;
        // Defaults
        let duration = req.sws.duration || <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
        let resContentLength = req.sws.res_clength || <span class="branch-1 cbranch-no" title="branch not covered" >0;</span>
